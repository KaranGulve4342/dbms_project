...
INSERT INTO
  `block`
VALUES
  (1, 'kaveri', 'Water problem', 11),
  (2, 'Narmadha', 'Plumbing work', 12),
  (3, 'yamuna', 'tenant issue', 13),
  (4, 'jamuna', NULL, 21);
...
INSERT INTO
  `owner`
VALUES
  (501, 'Sanchit C', 20, 'yes', 11, '14-Feb-2004'),
  (502, 'Kartik K', 21, 'yes', 21, '11-march-2003'),
  (503, 'Gaurav P', 20, 'no', 20, '12-June-2004'),
  (504, 'Krishna', 21, 'no', 31, '25-Sept-2003');
...
INSERT INTO
  `rental`
VALUES
  ('02-jan-2021', 25000, 11, 601),
  ('03-jan-2021', 25000, 12, 602),
  ('03-jan-2021', 35000, 13, 603),
  ('06-jan-2021', 15000, 21, 604),
  ('07-jan-2021', 15000, 31, 605);
...
INSERT INTO
  `room`
VALUES
  (11, '3bhk', 2, 'B-123', 1234, 1),
  (12, '2bhk', 2, 'B-124', 12345, 2),
  (13, '3bhk', 2, 'B-125', 123, 1),
  (21, '1bhk', 3, 'B-234', 456, 4),
  (31, '4bhk', 4, 'B-789', 2345, 4),
  (67, '1bhk', 7, 'B-890', 654, 3);
...
INSERT INTO
  `tenant`
VALUES
  (601, 'Vedant', '01-apr-02', 'no', 11, 19),
  (602, 'Ganesh', '23-aug-02', 'not paid', 12, 23),
  (603, 'Arjun', '12-jun-02', 'not paid', 13, 41),
  (604, 'Digvijay', '23-apr-02', 'not paid', 21, 35),
  (605, 'Atharva', '30-sep-02', 'not paid', 31, 56);
